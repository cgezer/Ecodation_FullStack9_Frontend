...
let numberCelal=186;
if(numberCelal>=100){
    console.log("sayı yüzden büyük yeniden deneyin");
}else if(numberCelal>=100 && numberCelal<=150){
    console.log("iyi bir değer yazdınız");
}
else if(numberCelal>=200){
    console.log("uygun bir sayı yazınız...");
}

let ifKisaYazma= (numberCelal>=200)?"sayı 200 den büyük":"sayı 200 den küçük";
